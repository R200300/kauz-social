...
const OTP = OTPInput.OTPInput

const InputOTP = React.forwardRef<
  React.ElementRef<typeof OTP>,
...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative flex h-10 w-10 items-center justify-center border border-input rounded-md bg-background text-sm shadow-sm transition-all",
